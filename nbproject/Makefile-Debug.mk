...
${OBJECTDIR}/CharacterSelectMenu.o: CharacterSelectMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/C/SDL64/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CharacterSelectMenu.o CharacterSelectMenu.cpp

${OBJECTDIR}/CharacterSelectState.o: CharacterSelectState.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/C/SDL64/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CharacterSelectState.o CharacterSelectState.cpp
...
${OBJECTDIR}/MusicSelectMenu.o: MusicSelectMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/C/SDL64/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MusicSelectMenu.o MusicSelectMenu.cpp
