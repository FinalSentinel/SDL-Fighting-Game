...
${OBJECTDIR}/AudioMenu.o: AudioMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AudioMenu.o AudioMenu.cpp

${OBJECTDIR}/BattleMenu.o: BattleMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BattleMenu.o BattleMenu.cpp
...
${OBJECTDIR}/CommandMenu.o: CommandMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CommandMenu.o CommandMenu.cpp

${OBJECTDIR}/ControlsMenu.o: ControlsMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ControlsMenu.o ControlsMenu.cpp
...
${OBJECTDIR}/GalleryMenu.o: GalleryMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GalleryMenu.o GalleryMenu.cpp
...
${OBJECTDIR}/LevelSelectMenu.o: LevelSelectMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LevelSelectMenu.o LevelSelectMenu.cpp
...
${OBJECTDIR}/OptionsMenu.o: OptionsMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OptionsMenu.o OptionsMenu.cpp
...
${OBJECTDIR}/StoryMenu.o: StoryMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StoryMenu.o StoryMenu.cpp
...
${OBJECTDIR}/TitleState.o: TitleState.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TitleState.o TitleState.cpp

${OBJECTDIR}/VersusMenu.o: VersusMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VersusMenu.o VersusMenu.cpp

${OBJECTDIR}/VersusState.o: VersusState.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VersusState.o VersusState.cpp

${OBJECTDIR}/VideoMenu.o: VideoMenu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VideoMenu.o VideoMenu.cpp
