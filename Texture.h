...
public:
    ...
    void render(SDL_Renderer* rend, int x = 0, int y = 0, int w = -1, int h = -1, SDL_Rect* clip = nullptr, double angle = 0, SDL_Point* axis = NULL, SDL_RendererFlip flip = SDL_FLIP_NONE) const;
